...
[_DEFAULT] = LAYOUT_planck_grid(
    ...
    KC_LCTL, KC_LGUI, KC_LALT, XXXXXXX, LOWER,   KC_SPC,  KC_BSPC, RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
 ...
 * |      |   7  |   8  |   9  |      |      |      |      |      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |   0  | Bksp |  Del |      |      |      |      | Home |Pg Up |Pg Dn |  End |
 * `-----------------------------------------------------------------------------------'
 */
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______,    KC_0, KC_BSPC,  KC_DEL, _______, _______, _______, _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END
),
...
[_ADJUST] = LAYOUT_planck_grid(
    _______, QK_BOOT, _______, _______, _______, _______, _______, _______, _______, _______, _______,  KC_DEL, 
     KC_PWR, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_PSCR,
